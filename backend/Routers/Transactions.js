...
import {
  addTransactionController, deleteTransactionController, getAllTransactionController, updateTransactionController,
  deleteMultipleTransactionsController, getSingleTransactionController,
...
router.route("/getTransaction/:id").get(getSingleTransactionController);
